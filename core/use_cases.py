...
class GenerateConversationalAudioUseCase:
    ...
    def execute(self, prompt: str, voice_name: str) -> dict:
        """
        ...
        ai_response_text = self.text_generator.generate_text(prompt)
...
class GenerateTestAudioUseCase:
    ...
    def execute(self, text: str, voice_name: str) -> str:
        """
        The Business Logic:
        ...
        # Call Port 1
        base64_audio = self.audio_generator.generate_base64(text, voice_name)
